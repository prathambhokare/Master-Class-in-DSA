...
struct node* getnode(struct bst_node* newdata);
void showlist(struct node* p_head_node);

struct node* search(struct node* p_head_node,struct bst_node* search_data){
...
int insertbeg(struct node* p_head_node,struct bst_node* newdata){
...
int insertend(struct node* p_head_node,struct bst_node* newdata){
...
int insertafter(struct node* p_head_node,struct bst_node* existing_data,struct bst_node* newdata){
...
int insertbefore(struct node* p_head_node,struct bst_node* existing_data,struct bst_node* newdata){
    struct node* prev=p_head_node;
    struct node* p_run=p_head_node->next;
    while (p_run!=NULL){
        prev=p_run;
...
struct bst_node* removebeg(struct node* p_head_node){
    struct bst_node* data=NULL;
...
int removedata(struct node* p_head_node,struct bst_node* existing_data){
    struct node* prev=p_head_node;
    struct node* p_run=p_head_node->next;
    while (p_run!=NULL){
        prev=p_run;
